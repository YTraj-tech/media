...
const Sidebar = () => {
  ...
  return (
    <div className=' flex flex-col '>
      {/* Logo Section */}
      <div className='mb-10 w-full flex  items-center justify-center md:justify-start'>
        <Image
          src={'/logo.webp'}
          alt='logo'
          width={200}
      ...
      <nav className='flex flex-col  gap-5 flex-1'>
        {navItems.map((item, index) => (
          <a
            ...
            href={item.href}
            className={`
               relative flex items-center-safe gap-4 px-4 py-3 rounded-xl
          ...
          >
            ...
            {/* Label */}
            <span className='flex-1 text-purple-400 text-2xl'>{item.label}</span>
